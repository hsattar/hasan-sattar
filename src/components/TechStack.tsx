...
export default function TechStack() {
    ...
    return (
        <>
        <h2 className="text-center text-3xl font-semibold mb-6">Tech Stack</h2>
        <div className="flex justify-center">
            <div className="grid grid-cols-4 gap-6 max-w-[800px] place-items-center place-content-center">
